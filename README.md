...
<img src="https://skillicons.dev/icons?i=python,javascript&theme=dark" height="50"/>

### 🧩 Frameworks & Bibliotecas

<img src="https://skillicons.dev/icons?i=django,flask,nodejs,react,angular&theme=dark" height="50"/>

### 🛠️ Ferramentas & Banco de Dados

<img src="https://skillicons.dev/icons?i=git,github,vscode,postgres,postman,html,css&theme=dark" height="50"/>
...
```javascript
const aprendendo = {
  backend:  ["Django REST Framework", "Flask-RESTful", "JWT Auth"],
  frontend: ["React Hooks", "Tailwind CSS", "Recharts"],
  devops:   ["Docker", "GitHub Actions"],
  sempre:   ["Boas práticas", "Clean Code", "Arquitetura de software"]
};
```
...
### 💬 *"Código bom não é aquele que o computador entende, é o que outros humanos conseguem ler."*
